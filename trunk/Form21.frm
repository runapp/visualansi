...
Public Sub ReSize_UI()
    vPic.Width = Form1.Pic1.Width
    vPic.Height = Form1.Pic1.Height
    ...
    End If
    'Me.Width = (Frame2.Left + Frame2.Width) * Screen.TwipsPerPixelX + 100
    Me.Width = (Frame2.Left + Frame2.Width) + 100
    'Debug.Print "W:" & (Frame1.Left + Frame1.Width) & " H:" & vPic.Height
    'Me.Height = (Frame1.Top + Frame1.Height) * Screen.TwipsPerPixelY + 800
    Me.Height = (Frame1.Top + Frame1.Height) + 800
...
Private Sub Me_LoadPic_Click()
    Call Form1.Command20_Click(0)
End Sub

Private Sub ME_SavePic_Click()
On Error GoTo out

    Form1.CDialog1.DialogTitle = "另存圖片"
    Form1.CDialog1.Filter = "*.bmp(點陣圖檔)|*.bmp"
    Form1.CDialog1.FileName = ""
    Form1.CDialog1.ShowSave
    If Dir(Form1.CDialog1.FileName, vbHidden Or vbDirectory Or vbReadOnly Or vbSystem) <> "" Then
        If MsgBox("檔案已經存在 請問你要覆蓋他嗎?", 49, "檔案已存在") = vbCancel Then Exit Sub
    End If
    Debug.Print Form1.CDialog1.FileName
    vPic.AutoRedraw = True
    
    'vPic.PaintPicture
    'vPic.Picture = vPic.Image
    SavePicture vPic.Image, Form1.CDialog1.FileName
    'vPic.AutoRedraw = True
    Exit Sub
out:
